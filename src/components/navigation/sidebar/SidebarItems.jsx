export const sidebarButtonsConfig = [
  ...
  },
  {
    ...
    submenuItems: [
      ...
      {
        href: "#project",
        title: "Envanter Guncelleme Gecmisi",
        svgIcon: (
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="24px"
  ...
  },
  {
    ...
    buttonTitle: "Test",
    submenuItems: [
      { href: "#folder", title: "tes" },
      { href: "#document", title: "test" },
      { href: "#project", title: "testt" },
    ],
    svgIcon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
